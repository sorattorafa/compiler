...
# Declarando e alocando a variavel 'retorna' com o tipo inteiro
retorna = builder.alloca(ir.IntType(32), name='retorna')
...
# Cria o return
returnVal_temp = builder.load(retorna, name='ret_temp', align=4)
